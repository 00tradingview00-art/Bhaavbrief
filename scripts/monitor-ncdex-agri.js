...
**WHO IS AFFECTED**
Write 2 flowing prose sentences — not a list. First sentence: name the commercial actors (farmers, mandis, exporters, millers) with their specific exposure. Second sentence: name the end consumers and their direct impact. Example: "Dal millers in Madhya Pradesh and Rajasthan buying chana on forward contracts see procurement costs reprice immediately as NCDEX futures move, while exporters shipping to Gulf markets face a shifting basis between domestic spot and international prices. Kirana stores stocking pulses in bulk and households in north India where dal is a dietary staple absorb the change at the retail shelf."

**BOTTOM LINE**
3 complete prose sentences — no category labels, no colons prefixing sentences. First sentence: name one specific business sector or mandi and one concrete consequence. Second sentence: name one specific NCDEX contract and its directional signal. Third sentence: name one specific food product or consumer group and the price direction. BANNED phrases: "farmers may benefit", "traders should watch", "businesses face higher costs", "investors should be aware", "market participants need to monitor".
