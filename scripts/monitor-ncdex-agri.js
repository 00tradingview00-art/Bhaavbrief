...
**WHO IS AFFECTED**
2–3 flowing prose sentences tracing the causal ripple from this specific agri event through the supply chain. Think in layers: (1) direct commercial actors — farmers, mandis, millers, exporters — and what specific cost, margin, or contract position changes for them today; (2) mid-chain businesses that process or package this commodity — food manufacturers, D2C food brands, restaurant chains, kirana wholesalers — and how their day-to-day procurement or pricing decision shifts; (3) end consumers — households, retail buyers — and what they pay more or less for.
...
Derive the affected chain from the actual agri commodity in this event, not from a template.
