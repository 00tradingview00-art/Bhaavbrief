<!--
prompts/reel_v2.md — versioned copy prompt for the main Instagram Reel
...
that specific day's content. NO other rule changed in this revision — see
v1's entry above for everything else.
...
Bump the filename (reel_v3.md, etc.) on any material change and update
