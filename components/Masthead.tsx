      ...
      <div style={{ maxWidth: 980, margin: '0 auto', padding: '0 1.5rem' }}>
        ...
        <div style={{
          ...
          <Link href="/" style={{ textDecoration: 'none' }}>
            <div style={{ fontFamily: "'Playfair Display', serif", fontSize: '2.1rem', fontWeight: 800, letterSpacing: '-0.025em', color: '#18180F', lineHeight: 1 }}>
              BhaavBrief
            </div>
            <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 9, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#C8720A', marginTop: 4 }}>
              India's Commodity Intelligence · Est. 2026
            </div>
          </Link>
          <div style={{ textAlign: 'right' }}>
            <p style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 10, color: '#8A8A7A', letterSpacing: '0.05em', lineHeight: 1.7 }}>{today}</p>
            <p style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 10, color: '#8A8A7A', lineHeight: 1.7 }}>bhaavbrief.in</p>
          </div>
        </div>
