...
> **Data note:** Live MCX session data was unavailable at publication time. OHLC figures below are derived from COMEX reference prices and USD/INR translation. Treat as indicative, not official MCX settlement values.
