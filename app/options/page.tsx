  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: { '@type': 'Answer', text: 'Max Pain is the strike price where the options market is putting the least weight behind a big move. Traders watch it because MCX prices often gravitate toward the Max Pain strike as expiry approaches, though it is not a guarantee.' },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: { '@type': 'Answer', text: 'PCR (Put-Call Ratio) reflects how options positioning is leaning across puts and calls for an expiry. Extreme readings are sometimes treated as a contrarian indicator near market turning points.' },
    },
    {
      '@type': 'Question',
