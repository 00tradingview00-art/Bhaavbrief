    ...
    <div style={{ background: '#FAFAF6', minHeight: '100vh' }}>
      <div style={{ maxWidth: 980, margin: '0 auto', padding: '3rem 1.25rem 4rem' }}>
        ...
        <div style={{ maxWidth: 680, marginBottom: '3rem' }}>
          <span style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 9, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#C8720A' }}>
            About
          </span>
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(1.8rem, 4vw, 2.6rem)', fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.025em', margin: '0.4rem 0 1.25rem' }}>
        ...
        <div className="about-grid">
          ...
          <div>
            ...
            <section style={{ marginBottom: '2.5rem' }}>
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.2rem', fontWeight: 700, marginBottom: '1.25rem', paddingBottom: '0.5rem', borderBottom: '0.5px solid #DDDDD0' }}>
                What we cover
              </h2>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                {COMMODITIES.map(c => (
                  <div key={c.name} style={{ display: 'flex', alignItems: 'flex-start', gap: 14, padding: '0.9rem 1rem', background: '#F3F2EC', border: '0.5px solid #DDDDD0' }}>
                    <span style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 10, color: '#C8720A', background: '#FFF7E0', border: '0.5px solid #D4A830', padding: '3px 8px', flexShrink: 0, marginTop: 2 }}>
                      {c.symbol}
                    </span>
                    <div>
                      <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 11, fontWeight: 500, color: '#18180F', marginBottom: 2 }}>{c.name}</div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                {PRINCIPLES.map(p => (
                  <div key={p.title} style={{ paddingLeft: '1rem', borderLeft: '2px solid #C8720A' }}>
                    <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 11, fontWeight: 500, color: '#18180F', marginBottom: 4 }}>{p.title}</div>
            ...
            <div style={{ background: '#18180F', padding: '1.25rem 1.5rem', color: '#FAFAF6' }}>
              <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 9, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#C8720A', marginBottom: '0.6rem' }}>
          ...
          <div>
            ...
            <div style={{ border: '0.5px solid #DDDDD0', marginBottom: '1.5rem' }}>
              {[
                ...
                <div key={s.label} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.75rem 1rem', borderBottom: i < arr.length - 1 ? '0.5px solid #DDDDD0' : 'none' }}>
                  <span style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 10, color: '#8A8A7A', letterSpacing: '0.04em' }}>{s.label}</span>
                  <span style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 11, color: '#18180F', fontWeight: 500 }}>{s.value}</span>
                </div>
              ))}
            </div>
            ...
            <div style={{ padding: '1.25rem', border: '0.5px solid #DDDDD0' }}>
              <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 9, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#8A8A7A', marginBottom: '0.75rem' }}>
                Get in touch
              </div>
              ...
              <a href="mailto:brief@bhaavbrief.in" style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 11, color: '#C8720A', textDecoration: 'none', borderBottom: '1px solid #C8720A', paddingBottom: 1 }}>
                brief@bhaavbrief.in
              </a>
            </div>
