    ...
    <>
      ...
      <div style={{ maxWidth: 820, margin: '0 auto', padding: '0 16px 64px' }}>
        ...
        <div style={infoBox}>
          ...
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 13, lineHeight: 2.2, color: '#18180F', minWidth: 300 }}>
        ...
        <div style={{ borderTop: '0.5px solid #DDDDD0', marginTop: 40, paddingTop: 28 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12 }}>
            ...
            <Link href="/learn/mcx-gold-contracts" style={{ fontSize: 13, color: '#18180F', textDecoration: 'none', border: '0.5px solid #DDDDD0', padding: '8px 14px' }}>MCX Gold contracts →</Link>
            ...
            <Link href="/learn/mcx-commodity-tax-india" style={{ fontSize: 13, color: '#18180F', textDecoration: 'none', border: '0.5px solid #DDDDD0', padding: '8px 14px' }}>MCX tax guide →</Link>
