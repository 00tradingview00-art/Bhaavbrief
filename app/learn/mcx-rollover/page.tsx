  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 820, margin: '0 auto', padding: '0 16px 64px' }}>
        ...
        <div style={infoBox}>
          <div style={{ fontSize: 11, fontFamily: 'var(--font-sans)', letterSpacing: '0.08em', textTransform: 'uppercase', color: '#C8720A', marginBottom: 8 }}>Rollover in one sentence</div>
        ...
        <div style={infoBox}>
          <div style={{ fontSize: 11, fontFamily: 'var(--font-sans)', letterSpacing: '0.08em', textTransform: 'uppercase', color: '#C8720A', marginBottom: 8 }}>Crude Oil (100 bbl) — long rollover, contango market</div>
          <div style={{ overflowX: 'auto' }}>
          <div style={{ fontFamily: 'var(--font-sans)', fontSize: 15, lineHeight: 2.1, color: '#18180F', minWidth: 320 }}>
        ...
        <div style={infoBox}>
          <div style={{ fontSize: 11, fontFamily: 'var(--font-sans)', letterSpacing: '0.08em', textTransform: 'uppercase', color: '#C8720A', marginBottom: 8 }}>Gold Mini (100g) — long rollover</div>
          <div style={{ overflowX: 'auto' }}>
          <div style={{ fontFamily: 'var(--font-sans)', fontSize: 15, lineHeight: 2.1, color: '#18180F', minWidth: 320 }}>
        ...
        <div style={infoBox}>
          <div style={{ fontSize: 11, fontFamily: 'var(--font-sans)', letterSpacing: '0.08em', textTransform: 'uppercase', color: '#C8720A', marginBottom: 8 }}>Angel One & other brokers</div>
          <p style={{ margin: 0, fontSize: 14, lineHeight: 1.75, color: '#18180F' }}>
        ...
        <div style={warnBox}>
          <div style={{ fontSize: 11, fontFamily: 'var(--font-sans)', letterSpacing: '0.08em', textTransform: 'uppercase', color: '#E05C00', marginBottom: 8 }}>Avoid these</div>
        ...
        <div style={{ borderTop: '0.5px solid #DDDDD0', marginTop: 40, paddingTop: 28 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12 }}>
            ...
            <Link href="/learn/mcx-contract-expiry" style={{ fontSize: 15, color: '#18180F', textDecoration: 'none', border: '0.5px solid #DDDDD0', padding: '8px 14px' }}>MCX contract expiry →</Link>
            <Link href="/learn/mcx-order-types" style={{ fontSize: 15, color: '#18180F', textDecoration: 'none', border: '0.5px solid #DDDDD0', padding: '8px 14px' }}>MCX order types →</Link>
            <Link href="/learn/how-much-money-to-start-mcx-trading" style={{ fontSize: 15, color: '#18180F', textDecoration: 'none', border: '0.5px solid #DDDDD0', padding: '8px 14px' }}>How much capital for MCX? →</Link>
