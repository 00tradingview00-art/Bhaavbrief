...
// ai-news.json is no longer actively written (flash-monitor replaced generate-news.js).
// Return empty after 6 hours so stale ET-rewrite items don't keep appearing in the feed.
